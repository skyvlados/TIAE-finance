...
class OperationTest < ActiveSupport::TestCase
  test 'should not save category without name without direction' do
    ...
    operation = Operation.new(category:, date: '2020-01-01', amount: 100, currency: 1)
  ...
  test 'should not save operation without name without date' do
    category = Category.create(name: 'Test')
    operation = Operation.new(direction: 2, category:, amount: 100, currency: 1)
    assert_not operation.save
  end

  test 'should not save operation without name without amount' do
    category = Category.create(name: 'Test')
    operation = Operation.new(direction: 2, category:, date: '2020-01-01', currency: 1)
    assert_not operation.save
  end

  test 'should not save operation without name without currency' do
    category = Category.create(name: 'Test')
    operation = Operation.new(direction: 2, category:, date: '2020-01-01', amount: 100)
    assert_not operation.save
  end

  test 'should save operation' do
    category = Category.create(name: 'Test')
    operation = Operation.new(direction: 2, category:, date: '2020-01-01', amount: 100, currency: 1)
    assert operation.save
  end

  test 'should not edit category without name without direction' do
    category = Category.create(name: 'Test')
    operation = Operation.create(direction: 2, category:, date: '2020-01-01', amount: 100, currency: 1)
    assert_not operation.update(direction: nil, category:, date: '2020-01-02', amount: 200, currency: 2)
  end
  ...
  test 'should not edit operation without name without date' do
    category = Category.create(name: 'Test')
    operation = Operation.create(direction: 2, category:, date: '2020-01-01', amount: 100, currency: 1)
    assert_not operation.update(direction: 1, category:, date: nil, amount: 200, currency: 2)
  end

  test 'should not edit operation without name without amount' do
    category = Category.create(name: 'Test')
    operation = Operation.create(direction: 2, category:, date: '2020-01-01', amount: 100, currency: 1)
    assert_not operation.update(direction: 1, category:, date: '2020-01-02', amount: nil, currency: 2)
  end

  test 'should not edit operation without name without currency' do
    category = Category.create(name: 'Test')
    operation = Operation.create(direction: 2, category:, date: '2020-01-01', amount: 100, currency: 1)
    assert_not operation.update(direction: 1, category:, date: '2020-01-02', amount: 200, currency: nil)
  end
